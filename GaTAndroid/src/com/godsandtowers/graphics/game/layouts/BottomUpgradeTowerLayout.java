...
public class BottomUpgradeTowerLayout implements ILayout {
	private Activity activity;
	private ImageView cancelImage;
	private Player player;

	public BottomUpgradeTowerLayout(Activity activity, final BottomLayout bottomLayout, final CenterLayout centerLayout) {
