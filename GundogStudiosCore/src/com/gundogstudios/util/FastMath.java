...
public class FastMath {
	...
	static {
		for (int i = 0; i < SIN_COUNT; i++) {
			...
			sin[i] = (float) java.lang.Math.sin(a);
			cos[i] = (float) java.lang.Math.cos(a);
		}
		for (int i = 0; i < 360; i += 90) {
			sin[(int) (i * degToIndex) & SIN_MASK] = (float) java.lang.Math.sin(i * degreesToRadians);
			cos[(int) (i * degToIndex) & SIN_MASK] = (float) java.lang.Math.cos(i * degreesToRadians);
		}
	}
	...
	static private final int ATAN2_DIM = (int) java.lang.Math.sqrt(ATAN2_COUNT);
	...
	static {
		for (int i = 0; i < ATAN2_DIM; i++) {
			for (int j = 0; j < ATAN2_DIM; j++) {
				...
				atan2[j * ATAN2_DIM + i] = (float) java.lang.Math.atan2(y0, x0);
			}
		}
	}
	...
	static public final void seedRandom(long seed) {
		random.setSeed(seed);
	}
